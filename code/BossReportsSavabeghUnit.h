...
#ifndef BossReportsSavabeghUnitH
#define BossReportsSavabeghUnitH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TBossReportsSavabeghForm : public TParentReportsForm
{
__published:	// IDE-managed Components
        ...
        TDBGrid *DBGrid1;
        TQuery *InsertHistoryToFlat1Query;
        TDBGrid *DBGrid2;
        TDBLookupComboBox *DBLookupComboBox2;
        TDBLookupComboBox *DBLookupComboBox1;
        TLabel *Label2;
        TTable *LTerms;
        TDataSource *LTermsDS;
        TLabel *Label3;
        TQuery *EmptyFlat1Query;
        TQuery *InsertGroupHistoryQuery;
...
public:		// User declarations
        __fastcall TBossReportsSavabeghForm(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TBossReportsSavabeghForm *BossReportsSavabeghForm;
//---------------------------------------------------------------------------
#endif

...
#pragma resource "*.dfm"
TQuestionsRadehBandyRep *QuestionsRadehBandyRep;
//---------------------------------------------------------------------------
__fastcall TQuestionsRadehBandyRep::TQuestionsRadehBandyRep(TComponent* Owner)
        : TParentRep(Owner)
{
}
//---------------------------------------------------------------------------
...
*/
void __fastcall TQuestionsRadehBandyRep::QRGroup2AfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
//1/3/85  QRBandGFooter2->Enabled=Query1->FieldByName("QGroupNo")->AsInteger!=0;
}
//---------------------------------------------------------------------------

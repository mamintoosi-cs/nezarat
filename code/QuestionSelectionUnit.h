...
#ifndef QuestionSelectionUnitH
#define QuestionSelectionUnitH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include "DMUnit.h"
//---------------------------------------------------------------------------
class TQuestionSelectionForm : public TForm
{
...
public:		// User declarations
        __fastcall TQuestionSelectionForm(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TQuestionSelectionForm *QuestionSelectionForm;
//---------------------------------------------------------------------------
#endif
